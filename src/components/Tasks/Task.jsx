...
const Task = ({ id, text, isDone, list, onEdit, onRemove, onDone }) => {
  const onChangeCheckbox = e => {
    onDone(list.id, id,  e.target.checked)
  }

  return (
    <div key={id} className="todo__tasks-list__tasks__tasks-items__task-row">
      <div className="todo__tasks-list__tasks__tasks-items__task-row__checkbox">
        <input
      ...
      <div className="todo__tasks-list__tasks__tasks-items__task-row__item-row">{text}</div>
